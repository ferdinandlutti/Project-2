...
function secondRoundScreen3({ route, navigation }) {
    ...
    <View style={styles.container}>
      <LinearGradient colors={["#003601", "#FA922F"]} style={styles.container}>
        ...
        <View style={styles.rulesContainer}>
          ...
          >
            <View style={styles.slide}>
              ...
              <Text style={styles.text}>Name a category </Text>
            </View>

            <View style={styles.slide}>
              <Text style={styles.text}>3 </Text>
              <Text style={styles.text}>
                The first person unable to name an element within the category
                drinks.
              </Text>
            </View>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            navigation.navigate("thirdRoundScreen", {
              players: players,
            });
          }}
        >
...
export default secondRoundScreen3;
