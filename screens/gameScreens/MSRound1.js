  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={["#003601", "#FA922F"]} style={styles.container}>
        ...
        <TypingAnimation text="Round 1" textStyle={styles.header} />
        <TypingAnimation
          text="Teammates can say everything they want about a person, just no rhymes or mention of the person"
